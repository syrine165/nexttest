                ...
                <div className='max-w-md w-full space-y-8'> 
                    <div>
                        ...
                        <p className='mt-2 text-center text-sm text-gray-600 '>
                            Or
                            <a href="#" className='font-medium text-darkBrand hover:text-brand px-2'>Sign Up</a>
                        </p>
                    </div>
                    <form className='mt-8 space-y-6'>
                        <div className='rounded-md shadow-sm -space-y-px'>
                            <div>
                                <input type="email" autoComplete='none' required className='appearance-none rounded-none relative block w-full px-3 py-2 border-gray-300 placeholder-gray-500
                                text-gray-900 rounded-t-md mb-2 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm'placeholder='Email adress'/> 
                            </div>

                            <div>
                                <input type="password" autoComplete='none' required className='appearance-none rounded-none relative block w-full px-3 py-2 border-gray-300 placeholder-gray-500
