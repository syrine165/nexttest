...
const Notif = () => {
    return(
<div id="toast-notification" className="fixed bottom-0 right-0 m-4 w-full max-w-xs p-4 text-gray-900 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-300" role="alert">
